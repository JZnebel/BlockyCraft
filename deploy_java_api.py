        ...
        if block_display_models and len(block_display_models) > 0:
            ...
            for model in block_display_models:
                ...
                for block_entity in blocks:
                    ...
                    x = block_entity.get('x', 0)
                    y = block_entity.get('y', 0)
                    z = block_entity.get('z', 0)
                ...
                # Write function file
                function_file_path = os.path.join(datapack_dir, f'{model_id}.mcfunction')
                with open(function_file_path, 'w') as f:
                    f.write('\n'.join(function_lines))

                print(f"  ✓ Generated function: {model_id}.mcfunction")
